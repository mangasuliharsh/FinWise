                ...
                <div className="px-6 pt-16 pb-24 md:px-16 lg:px-24 lg:flex items-center justify-between">
                        ...
                        <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mb-8">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="px-6 py-3 rounded-lg bg-white/10 border border-white/30 w-full focus:outline-none focus:ring-2 focus:ring-emerald-500"
                                    value={email}
                                ...
                                <button
                                    ...
                                    onClick={() => alert("Join waitlist with: " + email)}
                                >
                                    Join Waitlist
                                </button>
                            </div>
                    ...
                    <div className="hidden lg:block lg:w-1/2">
                        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 shadow-xl">
                            <img src="/api/placeholder/600/400" alt="FinWise Dashboard Preview"
                ...
                <div id="features" className="bg-indigo-900/50 py-16 px-6 md:px-16 lg:px-24">
                    <div className="max-w-5xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                            <div
                                className="bg-white/5 rounded-xl p-6 border border-white/10 hover:border-emerald-500/50 transition">
                                <div className="bg-emerald-500/20 rounded-lg p-3 inline-block mb-4">
                                    <BarChart2 className="h-6 w-6 text-emerald-400"/>
                                </div>
                                <h3 className="text-xl font-semibold mb-3">Smart Analytics</h3>
                                <p className="text-gray-300">Get insights into your spending habits and identify areas
                                    for improvement.</p>
                            </div>
                            ...
                            <div
                                ...
                                <p className="text-gray-300">Create custom budgets for different categories and track
                                    your progress.</p>
                            </div>
                            ...
                            <div
                                ...
                                <p className="text-gray-300">Easily categorize and monitor all your expenses in one
                                    place.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div id="testimonials" className="py-16 px-6 md:px-16 lg:px-24">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
                            ...
                            <div className="flex mb-4">
                                {[1, 2, 3, 4, 5].map(star => (
                                    <svg key={star} xmlns="http://www.w3.org/2000/svg"
                                         className="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor">
                                        <path
                                            d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118l-2.8-2.034c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                    </svg>
                                ))}
                            </div>
                            <p className="text-gray-300 mb-4">"FinWise completely changed how I manage my money. The
                                insights are invaluable!"</p>
                            <div className="flex items-center">
                                <div
                                    className="bg-emerald-500/20 rounded-full h-10 w-10 flex items-center justify-center mr-3">
                        ...
                        <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                            ...
                            <p className="text-gray-300 mb-4">"I've tried many financial apps, but FinWise stands out
                                with its intuitive interface and powerful features."</p>
                            <div className="flex items-center">
                                <div
                                    className="bg-emerald-500/20 rounded-full h-10 w-10 flex items-center justify-center mr-3">
                                    <Users className="h-5 w-5 text-emerald-400"/>
                        ...
                        <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                            ...
                            <p className="text-gray-300 mb-4">"The budgeting tools have helped me save more than I ever
                                thought possible. Highly recommend!"</p>
                            <div className="flex items-center">
                                <div
                                    className="bg-emerald-500/20 rounded-full h-10 w-10 flex items-center justify-center mr-3">
                                    <Users className="h-5 w-5 text-emerald-400"/>
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-400">Marketing Specialist</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="flex flex-col md:flex-row justify-between mb-8">
                            <div className="mb-8 md:mb-0">
                                ...
                                <p className="text-gray-400 max-w-xs">
                                    Smart financial planning for everyone. Take control of your money and achieve your
                                    financial goals.
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
                                <div>
                                    ...
                                    <ul className="space-y-2 text-gray-400">
                                        <li><a href="#features"
                                               className="hover:text-emerald-400 transition">Features</a></li>
                                        <li><a href="#pricing" className="hover:text-emerald-400 transition">Pricing</a>
                                        </li>
                                        <li><a href="/security"
                                               className="hover:text-emerald-400 transition">Security</a></li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-2 text-gray-400">
                                        <li><a href="/about" className="hover:text-emerald-400 transition">About</a>
                                        </li>
                                        <li><a href="/blog" className="hover:text-emerald-400 transition">Blog</a></li>
                                        <li><a href="/careers" className="hover:text-emerald-400 transition">Careers</a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-2 text-gray-400">
                                        <li><a href="/help" className="hover:text-emerald-400 transition">Help
                                            Center</a></li>
                                        <li><a href="/contact" className="hover:text-emerald-400 transition">Contact
                                            Us</a></li>
