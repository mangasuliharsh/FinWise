    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-900 to-indigo-950 text-white">
            ...
            <nav className="flex justify-between items-center px-6 py-4 md:px-16 lg:px-24">
                ...
                <button onClick={handleLogin} className="hidden md:block bg-emerald-500 hover:bg-emerald-600 px-5 py-2 rounded-lg font-medium transition">
                    Login
                </button>
            ...
            <div className="px-6 pt-16 pb-24 md:px-16 lg:px-24 lg:flex items-center justify-between">
                <div className="lg:w-1/2 lg:pr-12">
                    ...
                    <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mb-8">
                        <button onClick={handleLogin} className="bg-emerald-500 hover:bg-emerald-600 px-6 py-3 rounded-lg font-medium transition flex items-center justify-center">
                            Login with Google
                ...
                <div className="hidden lg:block lg:w-1/2">
                    <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 shadow-xl">
                        <img src="/api/placeholder/600/400" alt="FinWise Dashboard Preview" className="rounded-lg shadow-lg" />
                    </div>
                </div>
            </div>
            ...
            <div id="testimonials" className="py-16 px-6 md:px-16 lg:px-24">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
                    <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                        ...
                        <p className="text-gray-300 mb-4">"FinWise completely changed how I manage my money. The insights are invaluable!"</p>
                        <div className="flex items-center">
                    ...
                    <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                        ...
                        <p className="text-gray-300 mb-4">"I've tried many financial apps, but FinWise stands out with its intuitive interface and powerful features."</p>
                        <div className="flex items-center">
                            <div className="bg-emerald-500/20 rounded-full h-10 w-10 flex items-center justify-center mr-3">
                                <Users className="h-5 w-5 text-emerald-400" />
                            </div>
                    ...
                    <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                        ...
                        <p className="text-gray-300 mb-4">"The budgeting tools have helped me save more than I ever thought possible. Highly recommend!"</p>
                        <div className="flex items-center">
                            <div className="bg-emerald-500/20 rounded-full h-10 w-10 flex items-center justify-center mr-3">
                                <Users className="h-5 w-5 text-emerald-400" />
                            </div>
            ...
            <div className="bg-emerald-500/10 py-16 px-6 md:px-16 lg:px-24 border-t border-b border-emerald-500/20">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <button onClick={handleLogin} className="bg-emerald-500 hover:bg-emerald-600 px-8 py-4 rounded-lg font-medium transition text-lg">
